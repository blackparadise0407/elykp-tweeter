...
export default memo(function Tweet({ data }: TweetProps) {
    ...
    const { id, text, user, updatedAt } = data
    ...
    return (
        <div className="bg-white dark:bg-neutral-800 p-5 rounded-lg shadow">
            ...
            <div className="mt-5">
                <p className="text-neutral-600 dark:text-white">{text}</p>
                {/* <img
            ...
            <div className="flex py-1 border-t border-b dark:border-neutral-600">
                ...
                >
                    ...
                    <span className="text-sm capitalize text-gray-800 dark:text-gray-300">
                        {t('comment')}
                    </span>
                </Button>
            ...
            <div className="flex items-center gap-4 mt-2">
                ...
                <ReactTextareaAutosize
                    className="textarea bg-neutral-100 dark:bg-neutral-700 py-2.5 px-3 text-sm placeholder:text-sm rounded-lg border border-gray-200 dark:border-neutral-600"
                    maxRows={5}
                    minRows={1}
